...
setup(
    ...
    description='An asynchronous client to connect to IDM heatpumps via modbus',
    long_description = read('README.md'),
    long_description_content_type="text/markdown",
    keywords='Modbus IDM Asyncio',
    url='https://github.com/claashk/idmclient',
    project_urls={'Repository': 'https://github.com/claashk/idmclient'},
    classifiers=[
